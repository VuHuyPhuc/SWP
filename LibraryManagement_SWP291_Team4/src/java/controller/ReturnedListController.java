...
@WebServlet(urlPatterns = {"/returned-list"})
public class ReturnedListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            loans = loanDAO.getReturnedList(index, perPage);

            request.setAttribute("index", index);
            request.setAttribute("maxIndex", maxIndex);
            request.setAttribute("loans", loans);
            request.getRequestDispatcher("returnedList.jsp").forward(request, response);
        } catch (Exception e) {
