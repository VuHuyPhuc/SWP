            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <div class="bg-light p-4 mb-30">
                        <form id='f1' action="appointmentListCart?action=filterByCategory" method="POST">
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="row pb-3">
                        ...
                        <c:if test="${lsAppointment.size() == 0}">
                            <h1 style="color: red;">There is no item in appointment List Cart</h1>
                        </c:if>
                        <form class="form-control" action="appointmentListCart?action=addAppointmentToDataBase" method="POST">
                            <table class="table table-light table-borderless table-hover text-left mb-0">
                                ...
                                <tbody class="align-middle">
                                    ...
                                    <input type="hidden" name="bookId${count}" value="${a.book.id}">
                                    <tr>
                                        <td>${count}</td>
                                        ...
                                        <td class="align-middle">
                                            <div class="input-group quantity" style="width: 200px;">
                                                <input type="date" name="dateToGetBook${count}" class="form-control form-control-sm bg-secondary border-0 text-center" min="${a.date}" value="${a.date}">
                                            </div>
                                        </td>
                                        <td><a href="myAppoinmentDetail?appointmentId=${a.appointment_id}">See More</a></td>
                                        <td class="align-middle">
                                            <a href="appointmentListCart?action=delete&bookId=${a.book.id}">
                                                <button type="button" class="btn btn-sm btn-danger"> <!-- type button to prevent submit form -->
                                                    <i class="fa fa-times"></i>
                                                </button>
                                            </a>
                                        </td>
                                    </tr>
                                    <input type="hidden" name="amountOfAppointment" value="${count}">
