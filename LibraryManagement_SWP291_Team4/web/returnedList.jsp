                    ...
                    <div>
                        <nav>
                            <ul class="pagination justify-content-center">
                                <li class="page-item ${requestScope.index == 1?'disabled':''}"><a class="page-link" href="returned-list?index=${requestScope.index-1}">Previous</a></li>
                                    <c:forEach var="i" begin="1" end="${requestScope.maxIndex}">
                                    <li class="page-item ${requestScope.index == i?'active':''}"><a class="page-link" href="returned-list?index=${i}">${i}</a></li>
                                    </c:forEach>
                                <li class="page-item ${requestScope.index == maxIndex?'disabled':''}"><a class="page-link" href="returned-list?index=${requestScope.index+1}">Next</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
