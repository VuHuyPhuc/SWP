            ...
            <div class="row px-xl-5">
                <div class="col-12">
                    <nav class="breadcrumb bg-light mb-30">
                        ...
                        <a class="breadcrumb-item text-dark" href="#">My Reservation</a>
                    </nav>
                </div>
            </div>
        </div>
            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <div class="bg-light p-4 mb-30">
                        <form id='f1'action="myReservation" method="post">
                ...
                <div class="col-lg-9 col-md-8">
                                ...
                                <div class="ml-2">
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="myReservation?sort=lastest">Latest</a>
                                            <a class="dropdown-item" href="myReservation?sort=newest">Newest</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <table class="table table-light table-borderless table-hover text-left mb-0">
                        ...
                        <tbody class="align-middle">
                            ...
                            <c:forEach items="${lsReservation}" var="r">
                                <tr>
                                    <td>${count}</td>
                                    <td><img src="${r.book.image}" alt="" style="width: 50px;"></td>
                                    <td style="text-align: left;" class="align-middle">${r.book.title}</td>
                                    <td class="align-middle">
                                        <div class="input-group quantity" style="width: 200px;">
                                            <input type="date" disabled="" class="form-control form-control-sm bg-secondary border-0 text-center" value="${r.date}">
                                        </div>
                                    </td>
                                    <td><a href="myReservationDetail?reservationId=${r.reservation_id}">See More</a></td>
                                    <td class="align-middle">
                                        <a href="myReservation?action=delete&reservationId=${r.reservation_id}">
