                            ...
                            <c:if test="${requestScope.loans != null}">
                                <c:forEach items="${requestScope.loans}" var="l">
                                    <tr>
                                        ...
                                        <td class="align-middle">${l.fine}</td>
                                        <td class="align-middle">${l.status}</td>
                                        <td class="align-middle"><a href="${pageContext.request.contextPath}/overdue-list?id=${l.id}">See detail</a></td>
